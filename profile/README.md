...
TamboUI brings the TUI paradigms seen in things like Rust's [ratatui](https://github.com/ratatui/ratatui) or Pythons's [Textual](https://textual.textualize.io/) to the Java ecosystem.
